var e=Object.defineProperty,t=(t,n)=>{let r={};for(var i in t)e(r,i,{get:t[i],enumerable:!0});return n||e(r,Symbol.toStringTag,{value:`Module`}),r};(function(){let e=document.createElement(`link`).relList;if(e&&e.supports&&e.supports(`modulepreload`))return;for(let e of document.querySelectorAll(`link[rel="modulepreload"]`))n(e);new MutationObserver(e=>{for(let t of e)if(t.type===`childList`)for(let e of t.addedNodes)e.tagName===`LINK`&&e.rel===`modulepreload`&&n(e)}).observe(document,{childList:!0,subtree:!0});function t(e){let t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin===`use-credentials`?t.credentials=`include`:e.crossOrigin===`anonymous`?t.credentials=`omit`:t.credentials=`same-origin`,t}function n(e){if(e.ep)return;e.ep=!0;let n=t(e);fetch(e.href,n)}})();var n=null,r=[],i=null,a=[],o=null,s=0,c=new Set,l=100,u=0,d=class{_value;_subs=new Set;constructor(e){this._value=e}get value(){return n&&(this._subs.add(n),i?.add(this)),this._value}set value(e){Object.is(this._value,e)||(this._value=e,this._notify())}update(e){this.value=e(this._value)}peek(){return this._value}_removeSub(e){this._subs.delete(e)}_notify(){let e=[...this._subs];s>0?e.forEach(e=>c.add(e)):e.forEach(e=>e())}dispose(){this._subs.clear()}};function f(e){return new d(e)}function p(e){let t,s=new Set,c=o,d=()=>{if(typeof t==`function`&&t(),s.forEach(e=>e._removeSub(d)),s=new Set,r.push(n),a.push(i),n=d,i=s,++u>l)throw u=0,n=r.pop()||null,i=a.pop()||null,Error(`[Nix] Maximum effect re-execution depth exceeded (possible infinite loop).`);try{t=e()}catch(e){if(!c)throw e;c(e)}finally{u--,n=r.pop()||null,i=a.pop()||null}};return d(),()=>{typeof t==`function`&&t(),s.forEach(e=>e._removeSub(d)),s.clear()}}function m(e){let t=new d(void 0);return p(()=>{t.value=e()}),t}var h=class{__isNixComponent=!0;children;_slots=new Map;setChildren(e){return this.children=e,this}setSlot(e,t){return this._slots.set(e,t),this}slot(e){return this._slots.get(e)}};function g(e){return typeof e==`object`&&!!e&&!0===e.__isNixComponent}function _(e){return Symbol(e)}var v=[];function ee(){return[...v]}function y(){v.push(new Map)}function b(){v.pop()}function te(e,t){let n=v.splice(0);e.forEach(e=>v.push(e)),v.push(new Map);try{return t()}finally{v.splice(0),n.forEach(e=>v.push(e))}}_(`nix:portal-outlet`);function ne(e){let t=e.lastIndexOf(`>`),n=e.lastIndexOf(`<`);if(n<=t)return{type:`node`};let r=e.slice(n+1),i=r.match(/@([\w:.-]+)=["']?$/);if(i){let e=i[1].split(`.`);return{type:`event`,eventName:e[0],modifiers:e.slice(1),hadOpenQuote:i[0].endsWith(`"`)||i[0].endsWith(`'`)}}let a=r.match(/([\w:.-]+)=["']?$/);return a?{type:`attr`,attrName:a[1],hadOpenQuote:a[0].endsWith(`"`)||a[0].endsWith(`'`)}:{type:`node`}}function re(e,t){let n=Array(e.length).fill(0),r=``;for(let i=0;i<e.length;i++){let a=e[i];if(n[i]===1&&(a[0]===`"`||a[0]===`'`)&&(a=a.slice(1)),i<t.length){let e=t[i];if(e.type===`node`)r+=a+`\x3c!--nix-${i}--\x3e`;else if(e.type===`event`){let t=`@${e.modifiers.length?`${e.eventName}.${e.modifiers.join(`.`)}`:e.eventName}=`.length+(e.hadOpenQuote?1:0);r+=a.slice(0,-t)+` data-nix-e-${i}="${e.eventName}"`,e.hadOpenQuote&&(n[i+1]=1)}else{let t=`${e.attrName}=`.length+(e.hadOpenQuote?1:0);r+=a.slice(0,-t)+` data-nix-a-${i}="${e.attrName}"`,e.hadOpenQuote&&(n[i+1]=1)}}else r+=a}return r}function x(e){return typeof e==`object`&&!!e&&!0===e.__isNixTemplate}function ie(e){return typeof e==`object`&&!!e&&!0===e.__isKeyedList}function ae(e){let t,n=new Map,r=document.createTreeWalker(e,NodeFilter.SHOW_COMMENT);for(;t=r.nextNode();){let e=t,r=e.nodeValue?.match(/^nix-(\d+)$/);r&&n.set(parseInt(r[1]),e)}return n}function oe(e){let t=new Map;return e.querySelectorAll(`*`).forEach(e=>{let n=Array.from(e.attributes);for(let r of n){let n=r.name.match(/^data-nix-e-(\d+)$/);n?(t.set(parseInt(n[1]),{el:e,type:`event`,name:r.value}),e.removeAttribute(r.name)):(n=r.name.match(/^data-nix-a-(\d+)$/),n&&(t.set(parseInt(n[1]),{el:e,type:`attr`,name:r.value}),e.removeAttribute(r.name)))}}),t}function se(e,t,n){let r=[],i=[],a=ae(e),o=oe(e);for(let e=0;e<t.length;e++){let s=t[e],c=n[e];if(s.type===`event`){let t=o.get(e);if(!t)continue;let{el:n,name:i}=t,a=c,l=s.modifiers,u={};l.includes(`once`)&&(u.once=!0),l.includes(`capture`)&&(u.capture=!0),l.includes(`passive`)&&(u.passive=!0);let d={enter:`Enter`,escape:`Escape`,space:` `,tab:`Tab`,delete:`Delete`,backspace:`Backspace`,up:`ArrowUp`,down:`ArrowDown`,left:`ArrowLeft`,right:`ArrowRight`},f=e=>{if(l.includes(`prevent`)&&e.preventDefault(),l.includes(`stop`)&&e.stopPropagation(),!l.includes(`self`)||e.target===e.currentTarget){if(`key`in e){let t=e;for(let e of l){let n=d[e];if(n!==void 0&&t.key!==n||!d[e]&&e.length===1&&t.key.toLowerCase()!==e)return}}a(e)}};n.addEventListener(i,f,u),r.push(()=>n.removeEventListener(i,f,u));continue}if(s.type===`attr`){let t=o.get(e);if(!t)continue;let{el:n,name:i}=t;if(i===`ref`){c.el=n,r.push(()=>{c.el=null});continue}if(i===`show`||i===`hide`){let e=n,t=null;if(typeof c==`function`){let n=p(()=>{let n=!!c(),r=i===`show`?n:!n;t===null&&(t=e.style.display||``),e.style.display=r?t:`none`});r.push(n)}else (i===`show`?c:!c)||(n.style.display=`none`);continue}let a=(i===`value`||i===`checked`||i===`selected`)&&i in n;if(typeof c==`function`){let e=p(()=>{let e=c();a?n[i]=e??``:e==null||!1===e?n.removeAttribute(i):n.setAttribute(i,String(e))});r.push(e)}else a?n[i]=c??``:c!=null&&!1!==c&&n.setAttribute(i,String(c));continue}let l=a.get(e);if(!l)continue;if(typeof c!=`function`){if(g(c)){let e,t,n=c;y();try{try{n.onInit?.()}catch(e){if(!n.onError)throw e;n.onError(e)}e=n.render()._render(l.parentNode,l)}finally{b()}i.push(()=>{try{let e=n.onMount?.();typeof e==`function`&&(t=e)}catch(e){if(!n.onError)throw e;n.onError(e)}}),r.push(()=>{try{n.onUnmount?.()}catch{}try{t?.()}catch{}e()})}else if(x(c)){let e=c._render(l.parentNode,l);r.push(e)}else if(Array.isArray(c))for(let e of c)if(g(e)){let t,n;y();try{try{e.onInit?.()}catch(t){if(!e.onError)throw t;e.onError(t)}t=e.render()._render(l.parentNode,l)}finally{b()}i.push(()=>{try{let t=e.onMount?.();typeof t==`function`&&(n=t)}catch(t){if(!e.onError)throw t;e.onError(t)}}),r.push(()=>{try{e.onUnmount?.()}catch{}try{n?.()}catch{}t()})}else x(e)?e._render(l.parentNode,l):e!=null&&!1!==e&&l.parentNode.insertBefore(document.createTextNode(String(e)),l);else c!=null&&!1!==c&&l.parentNode.insertBefore(document.createTextNode(String(c)),l);continue}let u=null,d=null,f=null,m=ee(),h=p(()=>{let e=c();if(typeof e==`string`||typeof e==`number`)return d&&=(d(),null),void(u?u.nodeValue=String(e):(u=document.createTextNode(String(e)),l.parentNode.insertBefore(u,l)));if(u&&=(u.parentNode?.removeChild(u),null),d&&=(d(),null),e!=null&&!1!==e)if(x(e))d=e._render(l.parentNode,l);else if(g(e)){let t,n,r=e;te(m,()=>{try{r.onInit?.()}catch(e){if(!r.onError)throw e;r.onError(e)}t=r.render()._render(l.parentNode,l)});try{let e=r.onMount?.();typeof e==`function`&&(n=e)}catch(e){if(!r.onError)throw e;r.onError(e)}d=()=>{try{r.onUnmount?.()}catch{}try{n?.()}catch{}t()}}else if(ie(e)){f||=new Map;let t=l.parentNode,n=e.items.map((t,n)=>e.keyFn(t,n)),r=new Set(n);for(let[e,n]of f)if(!r.has(e)){n.cleanup();let r=n.start;for(;r!==n.end;){let e=r.nextSibling;t.removeChild(r),r=e}t.removeChild(n.end),f.delete(e)}let i=l;for(let r=n.length-1;r>=0;r--){let a=n[r],o=e.items[r];if(f.has(a)){let e=f.get(a);if(e.end.nextSibling!==i){let n=[],r=e.start;for(;n.push(r),r!==e.end;)r=r.nextSibling;for(let e of n)t.insertBefore(e,i)}i=e.start}else{let n=document.createComment(`nix-ke`),s=document.createComment(`nix-ks`);t.insertBefore(n,i),t.insertBefore(s,n);let c,l=e.renderFn(o,r);if(g(l)){let e,r;te(m,()=>{try{l.onInit?.()}catch(e){if(!l.onError)throw e;l.onError(e)}e=l.render()._render(t,n)});try{let e=l.onMount?.();typeof e==`function`&&(r=e)}catch(e){if(!l.onError)throw e;l.onError(e)}c=()=>{try{l.onUnmount?.()}catch{}try{r?.()}catch{}e()}}else c=l._render(t,n);f.set(a,{start:s,end:n,cleanup:c}),i=s}}}else if(Array.isArray(e)){let t=[];for(let n of e)if(g(n)){try{n.onInit?.()}catch(e){if(!n.onError)throw e;n.onError(e)}let e,r=n.render()._render(l.parentNode,l);try{let t=n.onMount?.();typeof t==`function`&&(e=t)}catch(e){if(!n.onError)throw e;n.onError(e)}t.push(()=>{try{n.onUnmount?.()}catch{}try{e?.()}catch{}r()})}else if(x(n))t.push(n._render(l.parentNode,l));else if(n!=null&&!1!==n){let e=document.createTextNode(String(n));l.parentNode.insertBefore(e,l),t.push(()=>e.parentNode?.removeChild(e))}d=()=>t.forEach(e=>e())}else u=document.createTextNode(String(e)),l.parentNode.insertBefore(u,l)});r.push(()=>{if(h(),d&&=(d(),null),u&&=(u.parentNode?.removeChild(u),null),f){for(let e of f.values())e.cleanup();f=null}})}return{disposes:r,postMountHooks:i}}function S(e,...t){let n=[],r=``;for(let t=0;t<e.length-1;t++){r+=e[t];let i=ne(r);n.push(i),r+=`__nix__`}let i=re(e,n);function a(e,r){let a=document.createElement(`template`);a.innerHTML=i;let o=a.content,{disposes:s,postMountHooks:c}=se(o,n,t),l=document.createComment(`nix-scope`);e.insertBefore(l,r);let u=o.firstChild;for(;u;){let t=u.nextSibling;e.insertBefore(u,r),u=t}return c.forEach(e=>e()),()=>{s.forEach(e=>e());let e=l.nextSibling;for(;e&&e!==r;){let t=e.nextSibling;e.parentNode?.removeChild(e),e=t}l.parentNode?.removeChild(l)}}return{__isNixTemplate:!0,_render:a,mount(e){let t=typeof e==`string`?document.querySelector(e):e;if(!t)throw Error(`[Nix] mount: contenedor no encontrado: ${e}`);let n=a(t,null);return{unmount(){n()}}}}}function ce(e,t){if(g(e)){let n,r,i=typeof t==`string`?document.querySelector(t):t;if(!i)throw Error(`[Nix] mount: container not found: ${t}`);y();try{try{e.onInit?.()}catch(t){if(!e.onError)throw t;e.onError(t)}n=e.render()._render(i,null)}finally{b()}try{let t=e.onMount?.();typeof t==`function`&&(r=t)}catch(t){if(!e.onError)throw t;e.onError(t)}return{unmount(){try{e.onUnmount?.()}catch{}try{r?.()}catch{}n()}}}return e.mount(t)}function le(e,t){let n={};for(let t of Object.keys(e))n[t]=f(e[t]);let r=n,i=Object.assign(Object.create(null),r,{$reset:function(){for(let t of Object.keys(e))n[t].value=e[t]}});if(t){let e=t(r);for(let t of Object.keys(e))t===`$reset`?console.warn(`[Nix] Store action name "$reset" is reserved and will be ignored.`):i[t]=e[t]}return i}var C=null,w=null;function ue(){if(!C)throw Error(`[Nix] No active router. Call createRouter() first.`);return C}function T(e){let t={};return new URLSearchParams(e).forEach((e,n)=>{t[n]=e}),t}function de(e){let t=new URLSearchParams;for(let[n,r]of Object.entries(e))r!=null&&!1!==r&&t.set(n,String(r));let n=t.toString();return n?`?`+n:``}function fe(e){return e===`*`?[{kind:`wildcard`}]:e.split(`/`).filter(Boolean).map(e=>e===`*`?{kind:`wildcard`}:e.startsWith(`:`)?{kind:`param`,name:e.slice(1)}:{kind:`literal`,value:e})}function pe(e,t){return t===`*`?e===``?`*`:e+`/*`:(e+(t.startsWith(`/`)?t:`/`+t)).replace(/\/+/g,`/`)||`/`}function me(e,t=``,n=[]){let r=[];for(let i of e){let e=pe(t,i.path),a=[...n,i.component],o=fe(e);r.push({fullPath:e,segments:o,chain:a,beforeEnter:i.beforeEnter}),i.children?.length&&r.push(...me(i.children,e,a))}return r}function he(e,t){let n=e.split(`/`).filter(Boolean),r=t.segments;if(r.length===1&&r[0].kind===`wildcard`)return{};let i=r.length>0&&r[r.length-1].kind===`wildcard`,a=i?r.slice(0,-1):r;if(i){if(n.length<a.length)return null}else if(n.length!==a.length)return null;let o={};for(let e=0;e<a.length;e++){let t=a[e];if(t.kind===`literal`){if(n[e]!==t.value)return null}else if(t.kind===`param`)try{o[t.name]=decodeURIComponent(n[e]??``)}catch{o[t.name]=n[e]??``}}return o}function ge(e){return e.segments.reduce((e,t)=>t.kind===`literal`?e+2:t.kind===`param`?e+1:e,0)}function E(e,t){let n,r={},i=-1;for(let a of t){let t=he(e,a);if(t===null)continue;let o=ge(a);o>i&&(n=a,r=t,i=o)}return n?{route:n,params:r}:void 0}function _e(e){function t(){return window.location.pathname||`/`}let n=t(),r=me(e),i=E(n,r),a=f(n),o=f(i?.params??{}),s=f(T(window.location.search)),c=[],l=[],u=0;function d(e,t,n,r,i){let a=[...c];n&&a.push(n);let o=++u;if(a.length===0)return void r();let s=0;(function n(c){if(o!==u)return;if(!1===c)return void i?.();if(typeof c==`string`)return void(c===e?r():_(c));if(s>=a.length)return void r();let l=a[s++](e,t);l instanceof Promise?l.then(n):n(l)})(void 0)}let p=!1;function m(e,t){let n=e.indexOf(`?`),r=n===-1?e:e.slice(0,n),i=n===-1?{}:T(e.slice(n)),a=t?{...i,...t}:i,o={};for(let[e,t]of Object.entries(a))t!=null&&!1!==t&&(o[e]=String(t));return{pathname:r,stringQuery:o}}w&&=(w(),null);let h=()=>{let e=t(),n=a.value,i=s.value,c=E(e,r),u=T(window.location.search);d(e,n,c?.route.beforeEnter,()=>{o.value=c?.params??{},s.value=u,a.value=e;for(let t of l)try{t(e,n)}catch{}},()=>{history.pushState(null,``,n+de(i))})};function g(e,t,n,r,i){o.value=r?.params??{},s.value=t,a.value=e;let c=e+de(t);i?history.replaceState(null,``,c):history.pushState(null,``,c);for(let t of l)try{t(e,n)}catch{}}function _(e,t){p=!0;let{pathname:n,stringQuery:i}=m(e,t),o=a.value,s=E(n,r);d(n,o,s?.route.beforeEnter,()=>g(n,i,o,s,!1))}window.addEventListener(`popstate`,h),w=()=>window.removeEventListener(`popstate`,h);let v={current:a,params:o,query:s,navigate:_,replace:function(e,t){p=!0;let{pathname:n,stringQuery:i}=m(e,t),o=a.value,s=E(n,r);d(n,o,s?.route.beforeEnter,()=>g(n,i,o,s,!0))},back:function(){history.back()},forward:function(){history.forward()},go:function(e){history.go(e)},isActive:function(e,t=!0){let n=a.value;return t?n===e:n===e||n.startsWith(e.endsWith(`/`)?e:e+`/`)},resolve:function(t){let n=E(t,r);if(!n)return{matched:!1,params:{},route:void 0};let i=n.route.chain[n.route.chain.length-1];return{matched:!0,params:n.params,route:function e(t){for(let n of t){if(n.component===i)return n;if(n.children){let t=e(n.children);if(t)return t}}}(e)}},beforeEach:function(e){return c.push(e),()=>{let t=c.indexOf(e);t!==-1&&c.splice(t,1)}},afterEach:function(e){return l.push(e),()=>{let t=l.indexOf(e);t!==-1&&l.splice(t,1)}},routes:e,_flat:r,_guards:c};return C&&console.warn(`[Nix] A router already exists. The previous router is being replaced. Only one router instance should be active at a time.`),C=v,queueMicrotask(()=>{p||d(n,``,E(n,r)?.route.beforeEnter,()=>{},()=>{history.replaceState(null,``,`/`);let e=E(`/`,r);a.value=`/`,o.value=e?.params??{},s.value={}})}),v}function D(){return ue()}var ve=class extends h{_depth;constructor(e=0){super(),this._depth=e}render(){let e=this._depth;return S`<div class="router-view">${()=>{let t=ue(),n=E(t.current.value,t._flat);return n?e>=n.route.chain.length?S`<span></span>`:n.route.chain[e]():S`<div style="color:#f87171;padding:16px 0">
          404 — Route not found: <strong>${t.current.value}</strong>
        </div>`}}</div>`}};function ye(){return S`
    ...
    `}function be(e){return S`
        <span style="color:#f87171;font-size:13px">
            ⚠ ${e instanceof Error?e.message:String(e)}
        </span>
    `}var O=new Map,xe=3e5,k=null,Se=xe;function Ce(){k===null&&(k=setInterval(()=>{let e=Date.now();for(let[t,n]of O)n.subscribers<=0&&e-n.fetchedAt>Se&&O.delete(t);O.size===0&&k!==null&&(clearInterval(k),k=null)},6e4))}function we(e){return O.get(e)}function Te(e,t){let n=O.get(e);O.set(e,{data:t,fetchedAt:Date.now(),subscribers:n?.subscribers??0}),Ce()}function Ee(e){let t=O.get(e);t&&t.subscribers++}function De(e){let t=O.get(e);t&&(t.subscribers=Math.max(0,t.subscribers-1))}function Oe(e,t){let n=O.get(e);return!!n&&Date.now()-n.fetchedAt<t}var A=new Map;function j(e){O.delete(e);let t=A.get(e);if(t)for(let e of t)e()}function M(e,t,n,r={}){let{fallback:i,errorFallback:a,resetOnRefresh:o=!1,staleTime:s=0,refetchOnMount:c=`always`}=r,l=i??ye(),u=a??be;return new class extends h{_state;constructor(){super();let t=we(e);this._state=f(t?{status:`resolved`,data:t.data}:{status:`pending`})}onMount(){A.has(e)||A.set(e,new Set);let t=A.get(e),n=()=>this._run();t.add(n),Ee(e);let r=we(e),i=Oe(e,s);return r?!1===c||c===`stale`&&i||c===`always`&&i&&s>0||this._fetch():this._run(),()=>{t.delete(n),t.size===0&&A.delete(e),De(e)}}_run(){(o||this._state.peek().status===`pending`)&&(this._state.value={status:`pending`}),this._fetch()}_fetch(){t().then(t=>{Te(e,t),this._state.value={status:`resolved`,data:t}},e=>{this._state.value={status:`error`,error:e}})}render(){return S`<div class="nix-query" style="display:contents">${()=>{let e=this._state.value;return e.status===`pending`?l:e.status===`error`?u(e.error):n(e.data)}}</div>`}}}function N(e=`Required`){return t=>t==null||t===``||Array.isArray(t)&&t.length===0?e:null}function ke(e,t=`Invalid format`){return n=>typeof n!=`string`||e.test(n)?null:t}function Ae(e=`Invalid email`){return ke(/^[^\s@]+@[^\s@]+\.[^\s@]+$/,e)}function je(e,t=[]){let n=f(e),r=f(!1),i=f(!1),a=f(null),o=m(()=>{if(a.value)return a.value;if(!r.value&&!i.value)return null;for(let e of t){let t=e(n.value);if(t)return t}return null});function s(t){if(!t||!(`value`in t))return e;let n=t;return typeof e==`boolean`?n.checked:typeof e==`number`?Number(n.value):n.value}return{value:n,error:o,touched:r,dirty:i,onInput:e=>{n.value=s(e.target),i.value=!0,a.value=null},onBlur:()=>{r.value=!0},reset:function(){n.value=e,r.value=!1,i.value=!1,a.value=null},_setExternalError:function(e){a.value=e,e&&(r.value=!0)}}}function Me(e,t={}){let n={};for(let r in e){let i=t.validators?.[r]??[];n[r]=je(e[r],i)}let r=m(()=>{let e={};for(let t in n)e[t]=n[t].value.value;return e}),i=m(()=>{let e={};for(let t in n){let r=n[t].error.value;r&&(e[t]=r)}return e}),a=m(()=>{for(let e in n)if(n[e].error.value)return!1;return!0}),o=m(()=>{for(let e in n)if(n[e].dirty.value)return!0;return!1});function s(e){for(let t in e)n[t]?._setExternalError(e[t]??null)}return{fields:n,values:r,errors:i,valid:a,dirty:o,handleSubmit:function(e){return i=>{i.preventDefault();for(let e in n)n[e].touched.value=!0;let a=r.value;if(t.validate){let e=t.validate(a);if(e){let t={},n=!1;for(let r in e){let i=e[r],a=Array.isArray(i)?i[0]??null:i??null;a&&(t[r]=a,n=!0)}if(n)return void s(t)}}for(let e in n)if(n[e].error.value)return;e(a)}},reset:function(){for(let e in n)n[e].reset()},setErrors:s}}var Ne=localStorage.getItem(`biblio_user`),Pe=localStorage.getItem(`biblio_token`),Fe=Ne?JSON.parse(Ne):null,P=le({token:Pe??``,user:Fe},e=>({setAuth(t,n){e.user.value=t,e.token.value=n,localStorage.setItem(`biblio_user`,JSON.stringify(t)),localStorage.setItem(`biblio_token`,n)},logout(){e.user.value=null,e.token.value=``,localStorage.removeItem(`biblio_user`),localStorage.removeItem(`biblio_token`)}})),F=m(()=>!!P.token.value),Ie=m(()=>P.user.value?.role??null),I=m(()=>P.user.value?.id??null);f(0);var Le=t({adminGuard:()=>B,authGuard:()=>z,consumePendingRedirect:()=>Re,setPendingRedirect:()=>R}),L=null;function R(e){L=e}function Re(){let e=L;return L=null,e}function ze(e){return e===`/login`||e===`/home`||e===`/`||e.startsWith(`/book/`)}var z=(e,t)=>{if(ze(e))return e===`/login`&&F.value||e===`/`?`/home`:void 0;if(!F.value)return R(e),`/login`},B=(e,t)=>{if(!F.value)return`/login`;if(Ie.value!==`ADMIN`)return`/home`},Be=[{id:1,name:`Carlos Mendoza`,email:`carlos@unicolombo.edu.co`,role:`STUDENT`,password:`123456`},{id:2,name:`María López`,email:`maria@unicolombo.edu.co`,role:`TEACHER`,password:`123456`},{id:3,name:`Admin Sistema`,email:`admin@unicolombo.edu.co`,role:`ADMIN`,password:`admin123`}];function V(e,t=400){return new Promise(n=>setTimeout(()=>n(e),t))}var Ve={async login(e){await V(null,600);let t=Be.find(t=>t.email===e.email&&t.password===e.password);if(!t)throw Error(`Credenciales inválidas`);let{password:n,...r}=t;return{...r,token:`mock-jwt-${r.id}-${Date.now()}`}}},H=f([]),He=0;function U(e,t=`info`,n=3500){let r=He++;H.update(n=>[...n,{id:r,message:e,type:t}]),setTimeout(()=>{H.update(e=>e.filter(e=>e.id!==r))},n)}var Ue={success:`bg-green-600 text-white`,error:`bg-red-600 text-white`,info:`bg-blue-600 text-white`},We=class extends h{render(){return S`
            <div class="fixed top-4 right-4 z-50 flex flex-col gap-2 max-w-sm">
                ${()=>H.value.map(e=>S`
                            <div class=${`px-4 py-3 rounded-lg shadow-lg text-sm font-medium animate-[slideIn_0.3s_ease] ${Ue[e.type]}`}>
                                ${e.message}
                            </div>
                        `)}
            </div>
        ...
        `}},Ge=`modulepreload`,Ke=function(e){return`/parcial-1-analisis-2-unicolombo/`+e},qe={},Je=function(e,t,n){let r=Promise.resolve();if(t&&t.length>0){let e=document.getElementsByTagName(`link`),i=document.querySelector(`meta[property=csp-nonce]`),a=i?.nonce||i?.getAttribute(`nonce`);function o(e){return Promise.all(e.map(e=>Promise.resolve(e).then(e=>({status:`fulfilled`,value:e}),e=>({status:`rejected`,reason:e}))))}r=o(t.map(t=>{if(t=Ke(t,n),t in qe)return;qe[t]=!0;let r=t.endsWith(`.css`),i=r?`[rel="stylesheet"]`:``;if(n)for(let n=e.length-1;n>=0;n--){let i=e[n];if(i.href===t&&(!r||i.rel===`stylesheet`))return}else if(document.querySelector(`link[href="${t}"]${i}`))return;let o=document.createElement(`link`);if(o.rel=r?`stylesheet`:Ge,r||(o.as=`script`),o.crossOrigin=``,o.href=t,a&&o.setAttribute(`nonce`,a),document.head.appendChild(o),r)return new Promise((e,n)=>{o.addEventListener(`load`,e),o.addEventListener(`error`,()=>n(Error(`Unable to preload CSS for ${t}`)))})}))}function i(e){let t=new Event(`vite:preloadError`,{cancelable:!0});if(t.payload=e,window.dispatchEvent(t),!t.defaultPrevented)throw e}return r.then(t=>{for(let e of t||[])e.status===`rejected`&&i(e.reason);return e().catch(i)})};function Ye(){let e=D(),t=f(!1),n=f(``),r=Me({email:``,password:``},{validators:{email:[N(`El correo es obligatorio`),Ae(`Correo inválido`)],password:[N(`La contraseña es obligatoria`)]}});return S`
        <div class="min-h-[calc(100vh-4rem)] flex items-center justify-center bg-gray-50 px-4">
            <div class="w-full max-w-md">
                <div class="bg-white rounded-2xl shadow-xl p-8">
                    ...
                    <form @submit=${r.handleSubmit(async r=>{t.value=!0,n.value=``;try{let t=await Ve.login({email:r.email,password:r.password});P.setAuth({id:t.id,name:t.name,email:t.email,role:t.role},t.token),U(`¡Bienvenido, ${t.name}!`,`success`);let n=(await Je(async()=>{let{consumePendingRedirect:e}=await Promise.resolve().then(()=>Le);return{consumePendingRedirect:e}},void 0)).consumePendingRedirect();e.navigate(n??`/home`)}catch(e){n.value=e instanceof Error?e.message:`Error al iniciar sesión`,U(n.value,`error`)}finally{t.value=!1}})} class="space-y-5">
                        <div>
                            ...
                            />
                            ${()=>{let e=r.fields.email.error.value;return e?S`<p class="mt-1 text-sm text-red-500">${e}</p>`:S`<span></span>`}}
                        </div>
                        ...
                        <div>
                            ...
                            />
                            ${()=>{let e=r.fields.password.error.value;return e?S`<p class="mt-1 text-sm text-red-500">${e}</p>`:S`<span></span>`}}
                        </div>

                        ${()=>n.value?S`<div class="p-3 bg-red-50 border border-red-200 rounded-lg text-sm text-red-700">${n.value}</div>`:S`<span></span>`}
    ...
    `}var W=[{id:1,title:`Cien años de soledad`,author:`Gabriel García Márquez`,publisher:`Editorial Sudamericana`,stock:3,cover:`https://covers.openlibrary.org/b/id/8228691-L.jpg`,synopsis:`La historia de la familia Buendía a lo largo de siete generaciones en el pueblo ficticio de Macondo.`},{id:2,title:`El Principito`,author:`Antoine de Saint-Exupéry`,publisher:`Reynal & Hitchcock`,stock:5,cover:`https://covers.openlibrary.org/b/id/8769371-L.jpg`,synopsis:`Un piloto perdido en el desierto del Sahara conoce a un pequeño príncipe que viene de un asteroide.`},{id:3,title:`Don Quijote de la Mancha`,author:`Miguel de Cervantes`,publisher:`Francisco de Robles`,stock:2,cover:`https://covers.openlibrary.org/b/id/12648289-L.jpg`,synopsis:`Las aventuras de un hidalgo manchego que enloquece leyendo libros de caballerías y sale a recorrer el mundo.`},{id:4,title:`1984`,author:`George Orwell`,publisher:`Secker & Warburg`,stock:0,cover:`https://covers.openlibrary.org/b/id/12648288-L.jpg`,synopsis:`En un futuro distópico, Winston Smith lucha contra un régimen totalitario que controla cada aspecto de la vida.`},{id:5,title:`Hábitos Atómicos`,author:`James Clear`,publisher:`Penguin Random House`,stock:4,cover:`https://covers.openlibrary.org/b/id/12890741-L.jpg`,synopsis:`Una guía práctica para construir buenos hábitos y romper los malos, basada en evidencia científica.`},{id:6,title:`Clean Code`,author:`Robert C. Martin`,publisher:`Prentice Hall`,stock:1,cover:`https://covers.openlibrary.org/b/id/7507472-L.jpg`,synopsis:`Manual de referencia para escribir código limpio, legible y mantenible en el desarrollo de software.`},{id:7,title:`El Arte de la Guerra`,author:`Sun Tzu`,publisher:`Ediciones Obelisco`,stock:3,cover:`https://covers.openlibrary.org/b/id/8091016-L.jpg`,synopsis:`Tratado militar chino escrito en el siglo V a.C. que aborda la estrategia y la táctica militar.`},{id:8,title:`Sapiens`,author:`Yuval Noah Harari`,publisher:`Debate`,stock:0,cover:`https://covers.openlibrary.org/b/id/10520644-L.jpg`,synopsis:`Un recorrido por la historia de la humanidad, desde los primeros Homo sapiens hasta la era moderna.`},{id:9,title:`Introduction to Algorithms`,author:`Thomas H. Cormen`,publisher:`MIT Press`,stock:2,cover:`https://covers.openlibrary.org/b/id/8474213-L.jpg`,synopsis:`Texto de referencia en ciencias de la computación que cubre una amplia variedad de algoritmos.`},{id:10,title:`La Metamorfosis`,author:`Franz Kafka`,publisher:`Kurt Wolff Verlag`,stock:6,cover:`https://covers.openlibrary.org/b/id/8406786-L.jpg`,synopsis:`Gregor Samsa despierta una mañana convertido en un enorme insecto y debe enfrentar las consecuencias.`}],G=[...W],Xe=G.length+1,K={async getAll(e){let t=G;if(e){let n=e.toLowerCase();t=G.filter(e=>e.title.toLowerCase().includes(n)||e.author.toLowerCase().includes(n))}return V([...t])},async getById(e){return V(G.find(t=>t.id===e)??null)},async create(e){let t={...e,id:Xe++};return G.push(t),V(t)},async update(e,t){let n=G.findIndex(t=>t.id===e);if(n===-1)throw Error(`Libro no encontrado`);return G[n]={...G[n],...t},V(G[n])}};function Ze(e){let t=D(),n=e.stock>0;return S`
        ...
        >
            <div class="h-48 bg-gradient-to-br from-indigo-100 to-indigo-50 flex items-center justify-center overflow-hidden relative">
                ${e.cover?S`<img src=${e.cover} alt=${e.title} class="h-full w-full object-cover group-hover:scale-110 transition-transform duration-300" />`:S`<span class="text-6xl group-hover:scale-110 transition-transform duration-300">📖</span>`}
    ...
    `}function q({size:e=`w-8 h-8`,trackColor:t=`border-indigo-200`,activeColor:n=`border-t-indigo-600`,padding:r=`py-16`}={}){return S`
        <div class=${`flex justify-center ${r}`}>
            <div class=${`animate-spin ${e} border-4 ${t} ${n} rounded-full`}></div>
        </div>
    `}function J({icon:e,message:t,action:n}){return S`
    ...
    `}function Qe(){let e=f(``),t=null;function n(n){e.value=n.target.value,t&&clearTimeout(t),t=setTimeout(()=>{j(`books`)},400)}return S`
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            ${M(`books`,()=>K.getAll(e.peek()||void 0),t=>t.length===0?J({icon:`📭`,message:`No se encontraron libros`}):S`
                        <p class="mb-4 text-sm text-gray-500">
                            ${t.length} libro${t.length===1?``:`s`} encontrado${t.length===1?``:`s`}${e.peek()?S` — "<strong>${e.peek()}</strong>"`:``}
                        </p>
    ...
    `}var $e=[{id:1,userId:1,bookId:1,bookTitle:`Cien años de soledad`,bookAuthor:`Gabriel García Márquez`,requestDate:`2026-02-15T10:30:00`,returnDate:`2026-03-01T09:00:00`,status:`RETURNED`},{id:2,userId:1,bookId:5,bookTitle:`Hábitos Atómicos`,bookAuthor:`James Clear`,requestDate:`2026-03-01T14:00:00`,returnDate:null,status:`BORROWED`},{id:3,userId:2,bookId:6,bookTitle:`Clean Code`,bookAuthor:`Robert C. Martin`,requestDate:`2026-02-20T08:00:00`,returnDate:null,status:`RESERVED`},{id:4,userId:1,bookId:3,bookTitle:`Don Quijote de la Mancha`,bookAuthor:`Miguel de Cervantes`,requestDate:`2026-03-05T16:45:00`,returnDate:null,status:`RESERVED`}],et=$e.length+1;function tt(){return et++}var Y=[...$e],X={async getAll(){return V([...Y])},async getByUser(e){return V([...Y.filter(t=>t.userId===e)])},async create(e,t){if(await V(null,300),Y.filter(t=>t.userId===e&&(t.status===`RESERVED`||t.status===`BORROWED`)).length>=5)throw Error(`Has alcanzado el límite máximo de 5 libros reservados/prestados.`);let n=W.find(e=>e.id===t);if(!n)throw Error(`Libro no encontrado.`);if(n.stock<=0)throw Error(`No hay copias disponibles de este libro.`);n.stock--;let r={id:tt(),userId:e,bookId:t,bookTitle:n.title,bookAuthor:n.author,requestDate:new Date().toISOString(),returnDate:null,status:`RESERVED`};return Y.push(r),r},async cancel(e){await V(null,300);let t=Y.findIndex(t=>t.id===e);if(t===-1)throw Error(`Reserva no encontrada.`);let n=Y[t];if(n.status!==`RESERVED`)throw Error(`Solo se pueden cancelar reservas en estado RESERVED.`);n.status=`CANCELLED`;let r=W.find(e=>e.id===n.bookId);r&&r.stock++},async confirmLoan(e){await V(null,300);let t=Y.find(t=>t.id===e);if(!t)throw Error(`Reserva no encontrada.`);if(t.status!==`RESERVED`)throw Error(`Solo se pueden confirmar préstamos en estado RESERVED.`);t.status=`BORROWED`},async returnBook(e){await V(null,300);let t=Y.find(t=>t.id===e);if(!t)throw Error(`Reserva no encontrada.`);if(t.status!==`BORROWED`)throw Error(`Solo se pueden devolver libros en estado BORROWED.`);t.status=`RETURNED`,t.returnDate=new Date().toISOString();let n=W.find(e=>e.id===t.bookId);n&&n.stock++}};function nt(){let e=D(),t=Number(e.params.value.id),n=f(!1),r=f(!1),i=f(null);function a(){e.navigate(`/home`)}function o(){e.navigate(`/my-loans`)}function s(){e.navigate(`/home`)}let c=()=>J({icon:`🔍`,message:`Libro no encontrado`,action:{label:`Ir al catálogo`,onClick:a}});return S`
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            ${M(`book-${t}`,()=>K.getById(t),t=>{if(!t)return c();let a=()=>i.value===null?t.stock:i.value;function l(){R(`/book/${t.id}`),U(`Inicia sesión para reservar`,`info`),e.navigate(`/login`)}async function u(){let e=I.value;if(e){n.value=!0;try{await X.create(e,t.id),i.value=a()-1,r.value=!0,j(`books`),j(`my-loans-${e}`),j(`book-${t.id}`),U(`¡Reserva exitosa! 🎉`,`success`)}catch(e){U(e instanceof Error?e.message:`Error al reservar`,`error`)}finally{n.value=!1}}}return S`
            <div class="bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-xl transition-shadow duration-300">
                <div class="md:flex">
                    <div class="md:w-1/3 bg-gradient-to-br from-indigo-100 to-indigo-50 flex items-center justify-center p-8 min-h-[300px] relative overflow-hidden">
                        ${t.cover?S`<img src=${t.cover} alt=${t.title} class="max-h-80 rounded-lg shadow-md hover:scale-105 transition-transform duration-300" />`:S`<span class="text-8xl">📖</span>`}
                    </div>
                ...
                <button
                    ...
                    @click=${u}
                >
                    ${()=>n.value?S`<span class="flex items-center gap-2"><span class="w-4 h-4 border-2 border-white/40 border-t-white rounded-full animate-spin inline-block"></span> Reservando...</span>`:S`<span>📚 Hacer Reserva</span>`}
                </button>
                ${()=>a()<=0?S`<p class="mt-2 text-sm text-red-500 animate-pulse">No hay copias disponibles actualmente</p>`:S`<span></span>`}
            `:S`
                    <button
    ...
    `}function Z(e){return new Date(e).toLocaleDateString(`es-CO`)}var rt={RESERVED:`bg-yellow-100 text-yellow-800`,BORROWED:`bg-blue-100 text-blue-800`,RETURNED:`bg-green-100 text-green-800`,CANCELLED:`bg-gray-100 text-gray-500`},it={RESERVED:`Reservado`,BORROWED:`Prestado`,RETURNED:`Devuelto`,CANCELLED:`Cancelado`};function Q(e){return S`
        <span class=${`px-2.5 py-1 rounded-full text-xs font-semibold ${rt[e]}`}>
            ${it[e]}
        </span>
    `}function at(){let e=D(),t=f(!1),n=f(``),r=f(null);function i(){let e=I.peek();e&&j(`my-loans-${e}`)}function a(){e.navigate(`/home`)}function o(e,i){r.value=e,n.value=i,t.value=!0}function s(){t.value=!1,r.value=null}async function c(){let e=r.value;if(e!==null){t.value=!1,r.value=null;try{await X.cancel(e),U(`Reserva cancelada`,`info`);let t=I.peek();t&&j(`my-loans-${t}`)}catch(e){U(e instanceof Error?e.message:`Error al cancelar`,`error`)}}}function l(e){e.key===`Escape`&&s()}return S`
        <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            ${()=>{let e=I.value;return e?M(`my-loans-${e}`,()=>X.getByUser(e),e=>e.length===0?J({icon:`📋`,message:`No tienes préstamos ni reservas aún`,action:{label:`📚 Explorar Catálogo`,onClick:a}}):S`
                                        ...
                                        <tbody class="divide-y divide-gray-100">
                                            ${e.map(e=>S`
                                                <tr class="hover:bg-gray-50 transition-colors">
                                                    ...
                                                    <td class="px-6 py-4 text-sm text-gray-500">${Z(e.requestDate)}</td>
                                                    <td class="px-6 py-4 text-sm text-gray-500">${e.returnDate?Z(e.returnDate):`—`}</td>
                                                    <td class="px-6 py-4">${Q(e.status)}</td>
                                                    <td class="px-6 py-4">
                                                        ${e.status===`RESERVED`?S`
                                                                <button
                                                                ...
                                                                >✕ Cancelar</button>
                                                            `:S`<span class="text-sm text-gray-300">—</span>`}
                                                    </td>
                                                </tr>
                                            `)}
                                        </tbody>
                        ...
                        `,{fallback:q()}):S`<p class="text-gray-500">No autenticado</p>`}}
        </div>
    `}function ot(e){let t=f(!1),n=Me({title:``,author:``,publisher:``,stock:``,synopsis:``},{validators:{title:[N(`El título es obligatorio`)],author:[N(`El autor es obligatorio`)],publisher:[N(`La editorial es obligatoria`)],stock:[N(`El stock es obligatorio`),e=>{let t=Number(e);return Number.isInteger(t)&&t>=0?null:`Debe ser un número entero ≥ 0`}]}}),r=n.handleSubmit(async r=>{t.value=!0;try{await K.create({title:r.title,author:r.author,publisher:r.publisher,stock:Number(r.stock)||0,synopsis:r.synopsis||void 0}),U(`Libro creado exitosamente`,`success`),n.reset(),e()}catch(e){U(e instanceof Error?e.message:`Error al crear libro`,`error`)}finally{t.value=!1}}),i=`w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 outline-none transition-shadow text-sm`;return S`
            ...
            <form @submit=${r} class="space-y-4">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        />
                        ${()=>{let e=n.fields.title.error.value;return e?S`<p class="mt-1 text-xs text-red-500">${e}</p>`:S`<span></span>`}}
                    </div>
                    <div>
                        ...
                        />
                        ${()=>{let e=n.fields.author.error.value;return e?S`<p class="mt-1 text-xs text-red-500">${e}</p>`:S`<span></span>`}}
                    </div>
                    <div>
                        ...
                        />
                        ${()=>{let e=n.fields.publisher.error.value;return e?S`<p class="mt-1 text-xs text-red-500">${e}</p>`:S`<span></span>`}}
                    </div>
                    <div>
                        ...
                        />
                        ${()=>{let e=n.fields.stock.error.value;return e?S`<p class="mt-1 text-xs text-red-500">${e}</p>`:S`<span></span>`}}
                    </div>
                </div>
                <div>
    ...
    `}var $=`w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 outline-none transition-shadow text-sm`;function st(){let e=f(null),t=f(``),n=f(``),r=f(``),i=f(``),a=f(``),o=f(!1),s=f(null),c=f([]),l=f(!1);function u(o){e.value=o,t.value=o.title,n.value=o.author,r.value=o.publisher,i.value=String(o.stock),a.value=o.synopsis??``}function d(){e.value=null}function p(e){e.key===`Escape`&&d()}async function m(){let s=e.peek();if(!s)return;let c=Number(i.value);if(!t.value.trim()||!n.value.trim()||!r.value.trim()){U(`Completa los campos obligatorios`,`error`);return}if(!Number.isInteger(c)||c<0){U(`El stock debe ser un entero ≥ 0`,`error`);return}o.value=!0;try{await K.update(s.id,{title:t.value.trim(),author:n.value.trim(),publisher:r.value.trim(),stock:c,synopsis:a.value.trim()||void 0}),U(`"${t.value.trim()}" actualizado`,`success`),d(),j(`books`)}catch(e){U(e instanceof Error?e.message:`Error al actualizar`,`error`)}finally{o.value=!1}}async function h(e){if(s.value===e){s.value=null;return}s.value=e,l.value=!0;try{c.value=(await X.getAll()).filter(t=>t.bookId===e)}catch{U(`Error al cargar reservas`,`error`)}finally{l.value=!1}}async function g(e,t){if(!(t<=0))try{await K.update(e,{stock:t-1}),j(`books`)}catch{U(`Error al actualizar stock`,`error`)}}async function _(e,t){try{await K.update(e,{stock:t+1}),j(`books`)}catch{U(`Error al actualizar stock`,`error`)}}let v=()=>e.value?S`
        ...
        `:S`<span></span>`,ee=()=>l.value?q({size:`w-5 h-5`,trackColor:`border-amber-200`,activeColor:`border-t-amber-500`,padding:`py-3`}):c.value.length===0?S`<p class="text-sm text-amber-700 text-center py-1">Sin reservas para este libro</p>`:S`
            ...
            <div class="flex flex-wrap gap-2">
                ${()=>c.value.map(e=>S`
                    <div class="flex items-center gap-2 text-xs bg-white rounded-lg px-3 py-1.5 shadow-sm border border-amber-100">
                        ...
                        <span class="text-gray-400">${Z(e.requestDate)}</span>
                        ${e.returnDate?S`<span class="text-gray-400">→ ${Z(e.returnDate)}</span>`:S`<span></span>`}
                        ${Q(e.status)}
                    </div>
                `)}
            </div>
        ...
        <div class="bg-white rounded-xl shadow-md overflow-hidden">
            ...
            ${M(`books`,()=>K.getAll(),e=>S`
                ...
                `,{fallback:q({size:`w-6 h-6`,padding:`py-8`})})}
        </div>
    `}function ct({reservations:e,currentFilter:t}){async function n(e){try{await X.confirmLoan(e.id),U(`Préstamo confirmado: "${e.bookTitle}"`,`success`),j(`reservations`)}catch(e){U(e instanceof Error?e.message:`Error al confirmar`,`error`)}}async function r(e){try{await X.returnBook(e.id),U(`Devolución registrada: "${e.bookTitle}"`,`success`),j(`reservations`),j(`books`)}catch(e){U(e instanceof Error?e.message:`Error al registrar devolución`,`error`)}}let i=t===`ALL`?e:e.filter(e=>e.status===t);return i.length===0?J({icon:`📋`,message:`No hay registros${t===`ALL`?``:` con estado "${it[t]}"`}`}):S`
        <div class="overflow-x-auto">
            <table class="w-full">
                <thead>
                    <tr class="bg-gray-50 text-left text-xs font-semibold text-gray-500 uppercase tracking-wider">
                        ...
                        <tr class="hover:bg-gray-50 transition-colors">
                            ...
                            <td class="px-6 py-4">
                                ${e.status===`RESERVED`?S`<button
                                        ...
                                        @click=${()=>n(e)}
                                    >✔ Confirmar préstamo</button>`:e.status===`BORROWED`?S`<button
                                            ...
                                            @click=${()=>r(e)}
                                        >↩ Registrar devolución</button>`:S`<span class="text-sm text-gray-300">—</span>`}
                            </td>
                        </tr>
                    `)}
                </tbody>
    ...
    `}var lt=[{value:`ALL`,label:`Todos`},{value:`RESERVED`,label:`Reservados`},{value:`BORROWED`,label:`Prestados`},{value:`RETURNED`,label:`Devueltos`},{value:`CANCELLED`,label:`Cancelados`}];function ut(){let e=f(`ALL`);return S`
        <div class="bg-white rounded-xl shadow-md overflow-hidden">
            ...
            ${M(`reservations`,()=>X.getAll(),t=>S`
            ${()=>ct({reservations:t,currentFilter:e.value})}
        `,{fallback:q({size:`w-6 h-6`,padding:`py-8`})})}
        </div>
    `}function dt(){let e=f(`books`);function t(){e.value=`books`}function n(){e.value=`loans`}return S`
    ...
    `}function ft(){let e=_e([{path:`/login`,component:()=>Ye()},{path:`/home`,component:()=>Qe()},{path:`/book/:id`,component:()=>nt()},{path:`/my-loans`,component:()=>at()},{path:`/admin`,component:()=>dt(),beforeEnter:B},{path:`*`,component:()=>Qe()}]);e.beforeEach(z);let t=window.location.pathname||`/`,n=z(t,t);if(typeof n==`string`&&n!==t)e.navigate(n);else if(n===void 0&&t===`/admin`){let n=B(t,t);typeof n==`string`&&e.navigate(n)}return e}var pt=class extends h{render(){let e=D(),t=(t,n)=>S`
            <a
                href=${t}
                ...
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div class="flex items-center justify-between h-16">
                        ...
                        <div class="flex items-center gap-1">
                            ${()=>{if(!F.value)return t(`/login`,`Iniciar Sesión`);let n=[t(`/home`,`Catálogo`),t(`/my-loans`,`Mis Préstamos`)];return Ie.value===`ADMIN`&&n.push(t(`/admin`,`Admin`)),S`
                                    ${n}
                                    ...
                                    <button
                                        ...
                                        @click=${()=>{P.logout(),U(`Sesión cerrada`,`info`),e.navigate(`/login`)}}
                                    >
                                        🚪 Salir
                                    </button>
                                `}}
        ...
        `}},mt=class extends h{render(){return S`
